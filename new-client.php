					...
					<div class="light-box form-box">
						<form action="" class="form-box__form">
							...
							<div class="form-group">
								...
								<input type="text" placeholder="Enter the Client's Full Name" id="fullname" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="text" placeholder="Enter the Client's Nationallity ID" id="nat-id" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="date" placeholder="Enter the Client's Birthdate" id="birthdate" class="form-control">
							</div>
							...
							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="text" placeholder="Enter the Client's Address" id="address" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="text" placeholder="Enter the Client's Email Address" id="email" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="text" placeholder="Enter the Client's Phone Number" id="phone-num" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="text" placeholder="Scan the Client's Fingerprint" id="fingerprint" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-user"></i>
								<input type="file" placeholder="Upload the Client's Picture" id="picture" class="form-control">
							</div>
						
							<div class="form-group">
								<input type="submit" value="add new client" class="submit form-control btn btn-block btn-primary">
							</div>
