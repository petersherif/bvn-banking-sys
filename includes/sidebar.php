<aside class="sidebar">
    ...
    <div class="sidebar__body">
        <ul class="sidebar__list">
            <li class="list__item <?php if (str_replace('/bank', '', $_SERVER['REQUEST_URI']) == '/home.php') { ?> active
            ...
            <li class="list__item <?php if (isset($_GET['new-client'])) { ?> active
                           <?php } ?>"><a
                        href="home.php?new-client"><i class="fa fa-user-plus icon-brown"></i> New
                    Client</a></li>
            ...
            <?php if (isset($_SESSION['loggedbvn'])) { ?>
                ...
                <li class="list__item <?php if (isset($_GET['all-transactions'])) { ?> active
                           <?php } ?>"><a
                            href="home.php?all-transactions"><i class="fa fa-list icon-blue"></i> All Transactions</a>
                </li>
            ...
            <li class="list__item<?php if (isset($_GET['add-employee'])) { ?> active
                           <?php } ?>"><i
                        class="fa fa-user-secret icon-black"></i><a href="home.php?add-employee">Add
                    Employee</a></li>
            <li class="list__item <?php if (isset($_GET['search-clients'])) { ?> active
                           <?php } ?>"><i
                        class="fa fa-users icon-black"></i><a href="home.php?search-clients">Search
                    Clients</a>
            </li>
            <li class="list__item<?php if (isset($_GET['search-employees'])) { ?> active
                           <?php } ?> "><i
                        class="fa fa-users icon-black"></i><a href="home.php?search-employees">Search
                    Employees</a>
            </li>
