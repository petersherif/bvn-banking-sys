					...
					<div class="light-box form-box">
						<form action="" class="form-box__form">
							...
							<div class="form-group">
								...
								<input type="text" placeholder="Enter the Reciever Account Number" id="rec-acc-num" class="form-control">
							</div>

							<div class="form-group">
								<i class="fa fa-money"></i>
								<input type="text" placeholder="Enter the Amount to Send" id="deposit-amount" class="form-control">
							</div>
