									...
									<div class="row">
										<div class="col-xs-12">
											<div class="accounts-list">
												<form method="POST" class="form-box form-box__form" style="margin-bottom: 0;">
													<div class="form-group">
	                          <i class="fa fa-university"></i>
	                          <select id="gender" name="gender" class="form-control" style="padding-top: 0;padding-bottom: 0;height: 30px;">
		                          <option>xx01</option>
															<option>xx31</option>
															<option>xx05</option>
	                          </select>
