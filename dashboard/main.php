						...
						<div class="col-xs-12">
							<div class="light-box profile-box profile-box--dashboard">
								<div class="row">
											...
											<div class="col-xs-12">
												<div class="accounts-list">
													<form method="post" class="form-box form-box__form"
														...
														<button name="go" type="submit" class="btn btn-primary--custom absolute top-0 right-1 mr2 h-100 bw0">Go</button>
													</form>
												</div>
											</div>
										</div>
									...
									<div class="col-xs-10 col-xs-offset-1 col-lg-8 col-lg-offset-0 pv3 profile__info-wrapper form-box" style="margin-bottom: 0;max-width: initial;">
										<div class="row">
											<div class="col-xs-12">
