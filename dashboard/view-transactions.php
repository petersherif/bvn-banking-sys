                        ...
                        <div class="col-xs-12">
                            <ul class="table__rows">
                                ...
                                foreach ($row as $record) {
                                    ...
                                    <li class="table__row data-row">
                                        <span class="row__cell"
                                              title="<?php echo $record["date"]; ?>"><?php echo $record["date"]; ?></span>
                                        <span class="row__cell color-accent withdraw"
                                              title="<?php if ($record["type"] == 1) {
                                                  echo $record["amount"];
                                              } else {
                                                  echo '-';
                                ...
                                foreach ($row_transfer as $record_transfer) {
                                    ...
                                    <li class="table__row data-row">
                                        <span class="row__cell"
                                              title="<?php echo $record_transfer["date"]; ?>"><?php echo $record_transfer["date"]; ?></span>
                                        <span class="row__cell color-accent withdraw" title="-">-</span>
                                        <span class="row__cell color-primary deposit" title="-">-</span>
                                        <span class="row__cell color-accent withdraw"
                                              title="<?php if ($record_transfer["sender_id"] == $user_id) {
                                                  echo $record_transfer["amount"];
                                              } else {
                                                  echo '-';
                                              } ?>"><?php if ($record_transfer["sender_id"] == $user_id) {
                                                echo $record_transfer["amount"];
                                            } else {
                                                echo '-';
                                            } ?></span>
