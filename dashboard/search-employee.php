							...
							<ul class="table__rows">
								...
								<?php foreach ($row as $record) { ?>
									<li class="table__row data-row"
										data-search="<?php echo $record["full_name"] ?><?php echo $record["user_name"] ?><?php echo $record["national_id"] ?><?php echo $record["email"] ?><?php echo $record["phone"] ?><?php if ($record["auth"] == 2) echo 'Manager'; else echo 'Employee'; ?>">
