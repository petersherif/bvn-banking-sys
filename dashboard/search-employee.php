                        ...
                        <div class="col-xs-12 ph4 search-bar">
                            <div class="form-group mv2">
                                <input type="search" class="form-control search-bar__input"
                                       placeholder="Search employees by name, national ID, email, phone, or position"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="table__rows">
                                ...
                                <?php foreach ($row as $record) { ?>
                                    <li class="table__row data-row"
                                        data-search="<?php echo $record["user_name"] ?><?php echo $record["national_id"] ?><?php echo $record["email"] ?><?php echo $record["phone"] ?><?php if ($record["auth"] == 2) echo 'Manager'; else echo 'Employee'; ?>">
                                        <span class="row__cell"
                                              title="<?php echo $record["user_name"] ?>"><?php echo $record["user_name"] ?></span>
                                        <span class="row__cell"
                                              title="<?php echo $record["national_id"] ?>"><?php echo $record["national_id"] ?></span>
                                        <span class="row__cell"
                                              title="<?php echo $record["email"] ?>"><?php echo $record["email"] ?></span>
                                        <span class="row__cell"
                                              title="<?php echo $record["phone"] ?>"><?php echo $record["phone"] ?></span>
                                        <span class="row__cell"
                                              title="<?php if ($record["auth"] == 2) echo 'Manager'; else echo 'Employee'; ?>"><?php if ($record["auth"] == 2) echo 'Manager'; else echo 'Employee'; ?></span>
                                        <span class="row__cell">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post" action="?search-employees">
                                                            ...
                                                            <button type="submit" class="btn btn-danger--custom mv1"><i
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="profile__info">
                            ...
                            <p class="info__text"><span class="info__title">Email : <span id="email"></span>  </span>
                            </p>
                            ...
                            <p class="info__text"><span class="info__title">Position :  <span id="pos"></span>  </span>
                            </p>

                            <p class="info__text"><span class="info__title">BIRTHDAY :<span id="birthday"></span></span>
                            </p>
                            <p class="info__text"><span class="info__title">ADDRESS : <span
                                            id="address"></span>  </span></p>
